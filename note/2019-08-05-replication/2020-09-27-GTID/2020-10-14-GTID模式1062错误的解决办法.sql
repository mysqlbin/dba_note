...
1. 通过删除从库的记录解决1062
	...
	*************************** 1. row ***************************
	  ...
	  Replicate_Wild_Ignore_Table: 
					   Last_Errno: 1062
					   Last_Error: Could not execute Write_rows event on table aiuaiuh9_db.table_aaaaaaaabbbbbbbb; Duplicate entry '46' for key 'PRIMARY', Error_code: 1062; handler error HA_ERR_FOUND_DUPP_KEY; the event's master log mysql-bin.000239, end_log_pos 76925054
					 Skip_Counter: 0
	...
	Master_SSL_Verify_Server_Cert: No
					...
					Last_IO_Error: 
				   Last_SQL_Errno: 1062
				   Last_SQL_Error: Could not execute Write_rows event on table aiuaiuh9_db.table_aaaaaaaabbbbbbbb; Duplicate entry '46' for key 'PRIMARY', Error_code: 1062; handler error HA_ERR_FOUND_DUPP_KEY; the event's master log mysql-bin.000239, end_log_pos 76925054
...
2. 通过跳过一个GTID来解决
	...
	*************************** 1. row ***************************
	  ...
	  Replicate_Wild_Ignore_Table: 
					   Last_Errno: 1062
					   Last_Error: Could not execute Write_rows event on table aiuaiuh9_db.table_aaaaaaaa; Duplicate entry '4' for key 'PRIMARY', Error_code: 1062; handler error HA_ERR_FOUND_DUPP_KEY; the event's master log mysql-bin.000239, end_log_pos 77187311
					 Skip_Counter: 0
	...
	Master_SSL_Verify_Server_Cert: No
					...
					Last_IO_Error: 
				   Last_SQL_Errno: 1062
				   Last_SQL_Error: Could not execute Write_rows event on table aiuaiuh9_db.table_aaaaaaaa; Duplicate entry '4' for key 'PRIMARY', Error_code: 1062; handler error HA_ERR_FOUND_DUPP_KEY; the event's master log mysql-bin.000239, end_log_pos 77187311
	  Replicate_Ignore_Server_Ids: 
				 Master_Server_Id: 1
					  Master_UUID: 7664fad8-49fd-11e8-a546-4201c0a8010a
				 Master_Info_File: mysql.slave_master_info
