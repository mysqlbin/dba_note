...
4. 小结
	...
	主键索引:
		...
		delete语句主键索引等值范围删除加锁：
			需要访问到不满足条件的第一行记录为止，并且加锁，语句执行结束后，会把不满足条件的记录锁进行释放。
			--尾点延伸
<<<<<<< HEAD:note/2020-03-15-事务隔离级别与锁/2021-08-04-一些加锁规则的验证/2021-08-06-RC隔离级别/2021-08-06-8.0.18版本RC隔离级别下-主键索引范围加锁规则的验证-尾点.sql
=======
			-- 3.2 等值范围更新--先根据主键索引更新数据再等值范围删除/更新加锁
>>>>>>> 1c3932e6906a888d0049b7ce4e003b50f89ebe67:note/2020-03-15-事务隔离级别与锁/2021-08-04-一些加锁规则的验证/2021-08-06-RC隔离级别/2021-08-06-主键索引范围加锁规则的验证-尾点.sql
