...
<<<<<<< HEAD:note/2020-03-15-事务隔离级别与锁/2021-08-04-一些加锁规则的验证/2021-08-06-RC隔离级别/2021-08-06-8.0.18版本RC隔离级别下-普通索引范围加锁规则的验证-尾点.sql
=======

------------------------------------------------------------------------------------------------------------------------------------------------------------
>>>>>>> 1c3932e6906a888d0049b7ce4e003b50f89ebe67:note/2020-03-15-事务隔离级别与锁/2021-08-04-一些加锁规则的验证/2021-08-06-RC隔离级别/2021-08-06-普通索引范围加锁规则的验证-尾点.sql
...
4. 小结	
	...
	4.3 范围加锁：
		lock in share mode模式和for update模式，对不满足条件的二级索引记录需要加锁，不需要回到主键索引记录上加锁， 语句结束不会把不满足条件的二级索引记录锁释放掉。
		update和delete语句，对不满足条件的二级索引记录需要加锁，需要回到主键索引记录上加锁, 语句结束会把不满足条件的锁释放掉(二级索引记录锁+对应的主键索引记录锁)。
