...
2. 分析辅助索引idx_num
	...
	[root@mgr9 data]# cat not_primary_recurse.log 
...
--分析 叶子节点编号为 2911 的数据页	
	[root@mgr9 data]# innodb_space -s ibdata1 -T base_db/page_info -p 2911 page-records > lead_node_2911.log
...
--分析 叶子节点编号为 2048 的数据页	
	[root@mgr9 data]# innodb_space -s ibdata1 -T base_db/page_info -p 2048 page-records > lead_node_2048.log
	
	[root@mgr9 data]# cat lead_node_2048.log
...
-- 分析 叶子节点编号为2909的数据页	
	[root@mgr9 data]# innodb_space -s ibdata1 -T base_db/page_info -p 2909 page-records > lead_node_2909.log
