...
3. b lock_rec_lock
	...
	Breakpoint 2, lock_rec_lock (impl=false, mode=1027, block=0x7efe3ba84748, heap_no=6, index=0x7efe44028970, thr=0x7efe44969330) at /usr/local/mysql/storage/innobase/lock/lock0lock.cc:2040
	2040		ut_ad(lock_mutex_own());
	(gdb) bt
	#0  lock_rec_lock (impl=false, mode=1027, block=0x7efe3ba84748, heap_no=6, index=0x7efe44028970, thr=0x7efe44969330) at /usr/local/mysql/storage/innobase/lock/lock0lock.cc:2040
	-- gap_mode=1024：#define LOCK_REC_NOT_GAP  1024 。行锁。
	#1  0x000000000194dcd5 in lock_clust_rec_read_check_and_lock (flags=0, block=0x7efe3ba84748, rec=0x7efe3d0d410a "\200", index=0x7efe44028970, offsets=0x7efe2c1f3d60, mode=LOCK_X, gap_mode=1024, thr=0x7efe44969330)
		at /usr/local/mysql/storage/innobase/lock/lock0lock.cc:6414
	#2  0x0000000001a4651c in sel_set_rec_lock (pcur=0x7efe44968a58, rec=0x7efe3d0d410a "\200", index=0x7efe44028970, offsets=0x7efe2c1f3d60, mode=3, type=1024, thr=0x7efe44969330, mtr=0x7efe2c1f4080) at /usr/local/mysql/storage/innobase/row/row0sel.cc:1254
	#3  0x0000000001a4f23c in row_search_mvcc (buf=0x7efe44028350 "\377", mode=PAGE_CUR_GE, prebuilt=0x7efe44968830, match_mode=0, direction=0) at /usr/local/mysql/storage/innobase/row/row0sel.cc:5524
	#4  0x00000000018c1784 in ha_innobase::index_read (this=0x7efe44028060, buf=0x7efe44028350 "\377", key_ptr=0x7efe44d7d1b0 "\005", key_len=8, find_flag=HA_READ_KEY_OR_NEXT) at /usr/local/mysql/storage/innobase/handler/ha_innodb.cc:8740
	#5  0x0000000000f39602 in handler::index_read_map (this=0x7efe44028060, buf=0x7efe44028350 "\377", key=0x7efe44d7d1b0 "\005", keypart_map=1, find_flag=HA_READ_KEY_OR_NEXT) at /usr/local/mysql/sql/handler.h:2809
	#6  0x0000000000f2b457 in handler::ha_index_read_map (this=0x7efe44028060, buf=0x7efe44028350 "\377", key=0x7efe44d7d1b0 "\005", keypart_map=1, find_flag=HA_READ_KEY_OR_NEXT) at /usr/local/mysql/sql/handler.cc:3039
	#7  0x0000000000f34e8f in handler::read_range_first (this=0x7efe44028060, start_key=0x7efe44028148, end_key=0x0, eq_range_arg=false, sorted=false) at /usr/local/mysql/sql/handler.cc:7383
	...
	Breakpoint 2, lock_rec_lock (impl=false, mode=3, block=0x7efe3ba84748, heap_no=1, index=0x7efe44028970, thr=0x7efe44969330) at /usr/local/mysql/storage/innobase/lock/lock0lock.cc:2040
	2040		ut_ad(lock_mutex_own());
	(gdb) bt
	#0  lock_rec_lock (impl=false, mode=3, block=0x7efe3ba84748, heap_no=1, index=0x7efe44028970, thr=0x7efe44969330) at /usr/local/mysql/storage/innobase/lock/lock0lock.cc:2040
	-- gap_mode=0：#define LOCK_ORDINARY     0。表示加的是 next-key lock。
	#1  0x000000000194dcd5 in lock_clust_rec_read_check_and_lock (flags=0, block=0x7efe3ba84748, rec=0x7efe3d0d4070 "supremum", index=0x7efe44028970, offsets=0x7efe2c1f3e10, mode=LOCK_X, gap_mode=0, thr=0x7efe44969330)
		at /usr/local/mysql/storage/innobase/lock/lock0lock.cc:6414
	#2  0x0000000001a4651c in sel_set_rec_lock (pcur=0x7efe44968a58, rec=0x7efe3d0d4070 "supremum", index=0x7efe44028970, offsets=0x7efe2c1f3e10, mode=3, type=0, thr=0x7efe44969330, mtr=0x7efe2c1f4130) at /usr/local/mysql/storage/innobase/row/row0sel.cc:1254
	#3  0x0000000001a4e70a in row_search_mvcc (buf=0x7efe44028350 "\371\005", mode=PAGE_CUR_GE, prebuilt=0x7efe44968830, match_mode=0, direction=1) at /usr/local/mysql/storage/innobase/row/row0sel.cc:5266
	#4  0x00000000018c249a in ha_innobase::general_fetch (this=0x7efe44028060, buf=0x7efe44028350 "\371\005", direction=1, match_mode=0) at /usr/local/mysql/storage/innobase/handler/ha_innodb.cc:9040
	#5  0x00000000018c26c3 in ha_innobase::index_next (this=0x7efe44028060, buf=0x7efe44028350 "\371\005") at /usr/local/mysql/storage/innobase/handler/ha_innodb.cc:9109
	#6  0x0000000000f2bec4 in handler::ha_index_next (this=0x7efe44028060, buf=0x7efe44028350 "\371\005") at /usr/local/mysql/sql/handler.cc:3125
...
4. 语句的加锁范围
	primary key: 
		record lock：[5] + next-key lock：(5, supremum]
