...
6. 二级索引等值查询加锁
	...
	(gdb) bt
	#0  lock_rec_lock (impl=false, mode=1026, block=0x7fb0361c7620, heap_no=10, index=0x7fb02402e6e0, thr=0x7fb025c01b68) at /usr/local/mysql/storage/innobase/lock/lock0lock.cc:2040
	-- mode=LOCK_S
	#1  0x000000000194dcd5 in lock_clust_rec_read_check_and_lock (flags=0, block=0x7fb0361c7620, rec=0x7fb0393a819b "\200", index=0x7fb02402e6e0, offsets=0x7fb028117ee0, mode=LOCK_S, gap_mode=1024, thr=0x7fb025c01b68)
		at /usr/local/mysql/storage/innobase/lock/lock0lock.cc:6414
	#2  0x0000000001a4b095 in row_sel_get_clust_rec_for_mysql (prebuilt=0x7fb025c013d0, sec_index=0x7fb02402f1c0, rec=0x7fb0395c80a6 "c曹操\200", thr=0x7fb025c01b68, out_rec=0x7fb028118770, offsets=0x7fb028118748, offset_heap=0x7fb028118750, vrow=0x0, mtr=0x7fb028118200)
		at /usr/local/mysql/storage/innobase/row/row0sel.cc:3649
	#3  0x0000000001a4f94a in row_search_mvcc (buf=0x7fb0249d7650 "\376", mode=PAGE_CUR_GE, prebuilt=0x7fb025c013d0, match_mode=1, direction=0) at /usr/local/mysql/storage/innobase/row/row0sel.cc:5773
	#4  0x00000000018c1784 in ha_innobase::index_read (this=0x7fb024b2fa40, buf=0x7fb0249d7650 "\376", key_ptr=0x7fb025c0e6a0 "", key_len=403, find_flag=HA_READ_KEY_EXACT) at /usr/local/mysql/storage/innobase/handler/ha_innodb.cc:8740
	#5  0x0000000000f39602 in handler::index_read_map (this=0x7fb024b2fa40, buf=0x7fb0249d7650 "\376", key=0x7fb025c0e6a0 "", keypart_map=1, find_flag=HA_READ_KEY_EXACT) at /usr/local/mysql/sql/handler.h:2809
	#6  0x0000000000f2b457 in handler::ha_index_read_map (this=0x7fb024b2fa40, buf=0x7fb0249d7650 "\376", key=0x7fb025c0e6a0 "", keypart_map=1, find_flag=HA_READ_KEY_EXACT) at /usr/local/mysql/sql/handler.cc:3039
	#7  0x00000000014ef7af in join_read_always_key (tab=0x7fb025c0ead0) at /usr/local/mysql/sql/sql_executor.cc:2275
	#8  0x00000000014ed267 in sub_select (join=0x7fb025c0d8c0, qep_tab=0x7fb025c0ead0, end_of_records=false) at /usr/local/mysql/sql/sql_executor.cc:1277
	#9  0x00000000014ecbfa in do_select (join=0x7fb025c0d8c0) at /usr/local/mysql/sql/sql_executor.cc:950
	#10 0x00000000014eab61 in JOIN::exec (this=0x7fb025c0d8c0) at /usr/local/mysql/sql/sql_executor.cc:199
	#11 0x0000000001583b64 in handle_query (thd=0x7fb024959490, lex=0x7fb02495b7b0, result=0x7fb025d14120, added_options=0, removed_options=0) at /usr/local/mysql/sql/sql_select.cc:184
	#12 0x000000000153996f in execute_sqlcom_select (thd=0x7fb024959490, all_tables=0x7fb025d13810) at /usr/local/mysql/sql/sql_parse.cc:5144
	#13 0x000000000153339d in mysql_execute_command (thd=0x7fb024959490, first_level=true) at /usr/local/mysql/sql/sql_parse.cc:2816
	#14 0x000000000153a849 in mysql_parse (thd=0x7fb024959490, parser_state=0x7fb02811a690) at /usr/local/mysql/sql/sql_parse.cc:5570
	#15 0x00000000015302d8 in dispatch_command (thd=0x7fb024959490, com_data=0x7fb02811adf0, command=COM_QUERY) at /usr/local/mysql/sql/sql_parse.cc:1484
	#16 0x000000000152f20c in do_command (thd=0x7fb024959490) at /usr/local/mysql/sql/sql_parse.cc:1025
	#17 0x000000000165f7c8 in handle_connection (arg=0x4bfca80) at /usr/local/mysql/sql/conn_handler/connection_handler_per_thread.cc:306
	#18 0x0000000001ce7612 in pfs_spawn_thread (arg=0x50145e0) at /usr/local/mysql/storage/perfschema/pfs.cc:2190
	#19 0x00007fb04e797ea5 in start_thread () from /lib64/libpthread.so.0
	#20 0x00007fb04d65d9fd in clone () from /lib64/libc.so.6
...
7. 二级索引等值更新加锁
	...
	(gdb) bt
	#0  lock_rec_lock (impl=false, mode=1027, block=0x7fb0361c7620, heap_no=10, index=0x7fb02402e6e0, thr=0x7fb024df2748) at /usr/local/mysql/storage/innobase/lock/lock0lock.cc:2040
	-- mode=LOCK_X
	#1  0x000000000194dcd5 in lock_clust_rec_read_check_and_lock (flags=0, block=0x7fb0361c7620, rec=0x7fb0393a819b "\200", index=0x7fb02402e6e0, offsets=0x7fb028117880, mode=LOCK_X, gap_mode=1024, thr=0x7fb024df2748)
		at /usr/local/mysql/storage/innobase/lock/lock0lock.cc:6414
	#2  0x0000000001a4b095 in row_sel_get_clust_rec_for_mysql (prebuilt=0x7fb024df1fb0, sec_index=0x7fb02402f1c0, rec=0x7fb0395c80a6 "c曹操\200", thr=0x7fb024df2748, out_rec=0x7fb028118110, offsets=0x7fb0281180e8, offset_heap=0x7fb0281180f0, vrow=0x0, mtr=0x7fb028117ba0)
		at /usr/local/mysql/storage/innobase/row/row0sel.cc:3649
	#3  0x0000000001a4f94a in row_search_mvcc (buf=0x7fb026785ac0 "\377", mode=PAGE_CUR_GE, prebuilt=0x7fb024df1fb0, match_mode=1, direction=0) at /usr/local/mysql/storage/innobase/row/row0sel.cc:5773
	#4  0x00000000018c1784 in ha_innobase::index_read (this=0x7fb025bc9340, buf=0x7fb026785ac0 "\377", key_ptr=0x7fb025301550 "", key_len=403, find_flag=HA_READ_KEY_EXACT) at /usr/local/mysql/storage/innobase/handler/ha_innodb.cc:8740
	#5  0x0000000000f39602 in handler::index_read_map (this=0x7fb025bc9340, buf=0x7fb026785ac0 "\377", key=0x7fb025301550 "", keypart_map=1, find_flag=HA_READ_KEY_EXACT) at /usr/local/mysql/sql/handler.h:2809
	#6  0x0000000000f2b3c0 in handler::ha_index_read_map (this=0x7fb025bc9340, buf=0x7fb026785ac0 "\377", key=0x7fb025301550 "", keypart_map=1, find_flag=HA_READ_KEY_EXACT) at /usr/local/mysql/sql/handler.cc:3039
	#7  0x0000000000f34e8f in handler::read_range_first (this=0x7fb025bc9340, start_key=0x7fb025bc9428, end_key=0x7fb025bc9448, eq_range_arg=true, sorted=true) at /usr/local/mysql/sql/handler.cc:7383
	#8  0x0000000000f32dd1 in handler::multi_range_read_next (this=0x7fb025bc9340, range_info=0x7fb028118c30) at /usr/local/mysql/sql/handler.cc:6450
	#9  0x0000000000f33c8c in DsMrr_impl::dsmrr_next (this=0x7fb025bc95a0, range_info=0x7fb028118c30) at /usr/local/mysql/sql/handler.cc:6837
	#10 0x00000000018d379c in ha_innobase::multi_range_read_next (this=0x7fb025bc9340, range_info=0x7fb028118c30) at /usr/local/mysql/storage/innobase/handler/ha_innodb.cc:20582
	#11 0x000000000171887c in QUICK_RANGE_SELECT::get_next (this=0x7fb024949440) at /usr/local/mysql/sql/opt_range.cc:11233
	#12 0x0000000001457dba in rr_quick (info=0x7fb028118dd0) at /usr/local/mysql/sql/records.cc:398
	#13 0x00000000015e7b84 in mysql_update (thd=0x7fb024959490, fields=..., values=..., limit=18446744073709551615, handle_duplicates=DUP_ERROR, found_return=0x7fb028119428, updated_return=0x7fb028119420) at /usr/local/mysql/sql/sql_update.cc:812
	#14 0x00000000015edf22 in Sql_cmd_update::try_single_table_update (this=0x7fb025d137d8, thd=0x7fb024959490, switch_to_multitable=0x7fb0281194cf) at /usr/local/mysql/sql/sql_update.cc:2891
	#15 0x00000000015ee453 in Sql_cmd_update::execute (this=0x7fb025d137d8, thd=0x7fb024959490) at /usr/local/mysql/sql/sql_update.cc:3018
	#16 0x00000000015351f1 in mysql_execute_command (thd=0x7fb024959490, first_level=true) at /usr/local/mysql/sql/sql_parse.cc:3606
	#17 0x000000000153a849 in mysql_parse (thd=0x7fb024959490, parser_state=0x7fb02811a690) at /usr/local/mysql/sql/sql_parse.cc:5570
	#18 0x00000000015302d8 in dispatch_command (thd=0x7fb024959490, com_data=0x7fb02811adf0, command=COM_QUERY) at /usr/local/mysql/sql/sql_parse.cc:1484
	#19 0x000000000152f20c in do_command (thd=0x7fb024959490) at /usr/local/mysql/sql/sql_parse.cc:1025
	#20 0x000000000165f7c8 in handle_connection (arg=0x4bfca80) at /usr/local/mysql/sql/conn_handler/connection_handler_per_thread.cc:306
	#21 0x0000000001ce7612 in pfs_spawn_thread (arg=0x50145e0) at /usr/local/mysql/storage/perfschema/pfs.cc:2190
	#22 0x00007fb04e797ea5 in start_thread () from /lib64/libpthread.so.0
	#23 0x00007fb04d65d9fd in clone () from /lib64/libc.so.6
