...
-rw-r-----. 1 mysql mysql 26G Nov 16 17:08 sbtest1.ibd
...
--oltp-table-size=100000 \
--oltp-tables-count=10 \
--oltp-read-only=off --report-interval=10 --rand-type=uniform --max-time=600 \
--max-requests=0 --percentile=99 run >> /home/coding001/2021_11_06.log &
