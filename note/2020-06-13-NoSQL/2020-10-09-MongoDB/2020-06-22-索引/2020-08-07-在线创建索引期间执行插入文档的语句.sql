...
4. 错误日志	
	...
	2020-08-07T11:36:18.258+0800 I  COMMAND  [conn1782] command aiuaiu_h5.table_clubgamelog appName: "MongoDB Shell" command: createIndexes { createIndexes: "table_clubgamelog", indexes: [ { key: { szToken: 1.0 }, name: "szToken_1" } ], lsid: { id: UUID("b5c1f3b9-6eaa-4aa6-8177-f15271f8572e") }, $clusterTime: { clusterTime: Timestamp(1596771255, 1), signature: { hash: BinData(0, 2BD9714F3531A2D9BBFA03D0373505D3DAE390B5), keyId: 6838881995993382915 } }, $db: "aiuaiu_h5" } numYields:81606 reslen:239 locks:{ ParallelBatchWriterMode: { acquireCount: { r: 81608 } }, ReplicationStateTransition: { acquireCount: { w: 81609 } }, Global: { acquireCount: { r: 1, w: 81608 } }, Database: { acquireCount: { r: 1, w: 81608 } }, Collection: { acquireCount: { r: 81608, w: 1, R: 1, W: 2 } }, Mutex: { acquireCount: { r: 4 } } } flowControl:{ acquireCount: 81607, timeAcquiringMicros: 38067 } storage:{ data: { bytesRead: 23191340682, timeReadingMicros: 32559107 }, timeWaitingMicros: { cache: 111 } } protocol:op_msg 77440ms
