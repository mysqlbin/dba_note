...
新建连接连到 149
	...
	mongoserver_uri = "mongodb://test_user:test123456@10.31.76.149:27017/admin?replicaSet=repl_set"
	...
	249宕机、223成为主库
		[root@database-02 ~]# mongo -host 10.31.76.149 -u admin -p admin123456
		repl_set:PRIMARY> 

		[root@database-02 ~]# mongo -host 10.31.76.149 -u admin -p admin123456
		MongoDB shell version v4.2.7
		connecting to: mongodb://10.31.76.149:27017/?compressors=disabled&gssapiServiceName=mongodb
		2020-06-19T14:14:45.316+0800 E  QUERY    [js] Error: couldnt connect to server 10.31.76.149:27017, connection attempt failed: SocketException: Error connecting to 10.31.76.149:27017 :: caused by :: Connection refused :
