...
2. 总结
    ...
    2. 
        ...
        2.2 InnoDB通过遍历索引记录来加锁：
            ...
            二级索引加锁跟二级索引对应的主键索引也会加锁，声明：如果通过二级索引查询能用到覆盖索引，这样二级索引对应的主键索引就不会加锁。
    ...
    6. 死锁, 对于 MySQL 来说, 是一件 习以为常的事情， 有很多原因导致了MySQL的死锁率很高, 包括隔离级别, GAP锁, 索引的顺序, 业务逻辑等。
