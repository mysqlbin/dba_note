...
CREATE TABLE `table_clubmember` (
  ...
  `nSafeScore` bigint(20) unsigned DEFAULT '0' COMMENT '保险柜里的积分',
...
) ENGINE=InnoDB AUTO_INCREMENT=93817 DEFAULT CHARSET=utf8mb4 COMMENT='俱乐部成员表';
...
SQL语句的性能问题： 从table_clubmember 扫描 18284 行记录， 最终得到 10664 行记录，还需要遍历 10664 行记录去查询 取出 nScore，directlyVipCount，addDirectlyVipCount，teamVipCount，addTeamCount，weekMyRebate，teamRebate
